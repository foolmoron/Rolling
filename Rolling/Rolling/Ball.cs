...
namespace Rolling
{
    class Ball
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if ((keyboardState.IsKeyDown(Keys.Left) || keyboardState.IsKeyDown(Keys.A) || (mouseState.RightButton == ButtonState.Pressed) && (mouseState.X <= middleX)) || gamePadState.ThumbSticks.Left.X < -.5)
            {
                rotationRate.X = 1.5f;
                rotationAmount.X = 1.0f;
            }
            else if ((keyboardState.IsKeyDown(Keys.Right) || keyboardState.IsKeyDown(Keys.D) || (mouseState.RightButton == ButtonState.Pressed) && (mouseState.X > middleX)) || gamePadState.ThumbSticks.Left.X > .5)
            {
                rotationRate.X = -1.5f;
                rotationAmount.X = -1.0f;
            }
            ...
            acceleration = Vector3.Zero;
            if (keyboardState.IsKeyDown(Keys.Up) || keyboardState.IsKeyDown(Keys.W) || mouseState.LeftButton == ButtonState.Pressed || gamePadState.ThumbSticks.Left.Y > .5)
            {
            ...
            else if (keyboardState.IsKeyDown(Keys.Down) || keyboardState.IsKeyDown(Keys.S) || gamePadState.ThumbSticks.Left.Y < -.5)
            {
                rotationRate.Y = MathHelper.Clamp(rotationRate.Y + 0.5f, -10, 10);
                if (velocity.Length() < 2000f && onGround) 
                {
