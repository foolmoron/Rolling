    ...
    namespace Rolling
    {
        class Sound
        {
            ...
            public static void playSoundOnce(string s, ContentManager Content, float volume)
            {

                soundEngine = Content.Load<SoundEffect>(s);
                SoundEffectInstance soundEngineInstanceOne = soundEngine.CreateInstance();
                soundEngineInstanceOne.Volume = volume;
                soundEngineInstanceOne.Play();
            }
            ...
            public static void stopSound(string s, ContentManager Content)
            {
